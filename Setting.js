...
global.sudo  =  process.env.SUDO || "263 78 962 2747" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"Watson-XD",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '22_06_2024_SIGMA_MD_AKJKbKep_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'watsonxd',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `its watsonxd`, // ADD YOUR NAME
